...
$\mathrm{Score} = \frac 1 4  \sum\limits_{i=1}^{4}  \frac{\mathrm{MSE_{algo}}^{(i)}}{\mathrm{MSE_{bl}}^{(i)}}, \,\, \textrm{ where:}$
$\mathrm{Score} = \frac 1 4  \sum\limits\_{i=1}^{4}  \frac{\mathrm{MSE\_{algo}}^{(i)}}{\mathrm{MSE\_{bl}}^{(i)}}, \\,\\, \textrm{ where:}$
